...
void ShowerSumEnergy_I(const std::string inputName = "/pnfs/sbn/persistent/analysis/CAF/202106PAC/workshop_SBNWorkshop0421_prodoverlay_corsika_cosmics_cosmics_proton_genie_nu_spill_gsimple-config_caf_icarus/reduced_flatcafs/*.root")
//change path file to all files in icarus && change to look for calo2t rk energy (see Tbrwoser)
{
 ...
 //Sum Track Length Plot
  ...
  hSumTrks->Draw("hist");
  c1->Print("icarusplots/Icaurs_SumofShowerEnergies.png");
