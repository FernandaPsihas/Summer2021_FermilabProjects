...
void SumofTracksandShowers(const std::string inputName = "/pnfs/sbnd/persistent/sbndpro/mcp/mc/workshop/SBNWorkshop0421/prodoverlay_corsika_cosmics_proton_genie_nu_spill_gsimple-configf-v1_tpc/v09_19_00_01/caf/flat_caf_*")
//change path file to all files in icarus && change to look for calo2t rk energy (see Tbrwoser)
{
 ...
 //Sum Track Length Plot
  ...
  c1->Print("sbndplots/SumofTracksandShowers.png");
