#define betaTree_Plane0_cxx
#include "betaTree_Plane0.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void betaTree_Plane0::Loop()
{
//   In a ROOT session, you can do:
//      root> .L betaTree_Plane0.C
//      root> betaTree_Plane0 t
...
//Here we can create all of our plots
  ...
  double xBins[11] = {0, 17.5, 35, 52.5, 70, 87.5, 105, 122.5, 140, 157.5, 175};
  double yBins[11] = {-120, -96, -72, -48, -24, 0, 24, 48, 72, 96, 120};
  double zBins[11] = {350, 420, 490, 560, 630, 700, 770, 840, 910, 980, 1050};
  double recoBins[11] = {0.25, 0.345, 0.44, 0.535, 0.63, 0.725, 0.82, 0.915, 1.01, 1.105, 1.2};
  ...
  //Stuff for root
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(betaRecoEnergy_plane0 == 0) continue;

      double energyResolution = ((betaRecoEnergy_plane0/100)-betaTrueEnergy)/betaTrueEnergy;
	...
	if(betaRecoEnergy_plane0/100 > recoBins[recobin] && betaRecoEnergy_plane0/100 <= recoBins[recobin+1]){
