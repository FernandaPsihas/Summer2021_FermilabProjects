...
void LookingAtHitsfromBetasPlane2(){
  ...
  filenames.erase(filenames.begin()+500,filenames.end());
  ...
  TH2F* Bi214_PrecisionvsReco = new TH2F("Bi214_PrecisionvsReco","",100,0,5,50,-1.3,2.1);
  ...
  for (gallery::Event ev(filenames) ; !ev.atEnd(); ev.next()) {
      ...
      if(mcparts[mcp].PdgCode() == 11) // check if it is a beta
	{
	  ...
	  if(betaRecoEnergy_plane2 > 0 && betaPrecision < 5){
	    ...
	    Bi214_PtvsReco->Fill(betaRecoEnergy_plane2/100,betaMomentumT);
	    Bi214_CZvsCX->Fill(betaCreationX,betaCreationZ);
	    Bi214_CZvsReco->Fill(betaRecoEnergy_plane2/100,betaCreationZ);
	    Bi214_CXvsReco->Fill(betaRecoEnergy_plane2/100,betaCreationX);
	  }
	  else{
  ...
  Bi214_PrecisionvsReco->SetTitle("Plane 2: Precision vs Reco");
  Bi214_PrecisionvsReco->Draw("colz");
  Bi214_PrecisionvsReco->SaveAs("Plane2_PrecisionvsReco.root");
  /*
  ...
  Bi214_betaRecoEnergy->SetTitle("Plane 2: Reconstructed Energy Beta Spectrum");
  ...
  Bi214_betaTrueVsRecoEnergy->SetTitle("Plane 2: Reconstructed vs. True Beta Energy");
  ...
  Bi214_betaFailedRecoTime->SetTitle("Plane 2: Reconstructed Time of Betas");
  ...
  Bi214_PrecisionvsCX->SetTitle("Plane 2: Precision vs. X Creation Vertex");
  ...
  Bi214_PrecisionvsCY->SetTitle("Plane 2: Precision vs. Y Creation Vertex");
  ...
  Bi214_PrecisionvsCZ->SetTitle("Plane 2: Precision vs. Z Creation Vertex");
  ...
  Bi214_PrecisionvsCT->SetTitle("Plane 2: Precision vs. Reconstructed Time");
  ...
  Bi214_PrecisionvsReco->SetTitle("Plane 2: Precision vs. Reconstructed Energy");
  Bi214_PrecisionvsReco->Draw("colz");
  ...
  Bi214_PrecisionvsTrue->SetTitle("Plane 2: Precision vs. True Energy");
  ...
  Bi214_PrecisionvsXMom->SetTitle("Plane 2: Precision vs. X Momentum");
  ...
  Bi214_PrecisionvsYMom->SetTitle("Plane 2: Precision vs. Y Momentum");
  ...
  Bi214_PrecisionvsZMom->SetTitle("Plane 2: Precision vs. Z Momentum");
  ...
  Bi214_PrecisionvsTMom->SetTitle("Plane 2: Precision vs. Transverse Momentum");
  ...
  Bi214_PtvsReco->SetTitle("Plane 2: Transverse Momentum vs. Reconstructed Energy");
  ...
  Bi214_CZvsCX->SetTitle("Plane 2: Creation Z vs. Creation X");
  ...
  Bi214_CZvsReco->SetTitle("Plane 2: Creation Z vs. Reconstructed Energy");
  ...
  Bi214_CXvsReco->SetTitle("Plane 2: Creation X vs. Reconstructed Energy");
