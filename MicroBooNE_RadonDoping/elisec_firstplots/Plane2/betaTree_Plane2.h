...
// Mon Jun 21 16:21:16 2021 by ROOT version 6.12/06
// from TTree betaTree/ForEachTruthBeta
// found on file: outfile_mc_TESTCOMPARE.root
//////////////////////////////////////////////////////////

#ifndef betaTree_Plane2_h
#define betaTree_Plane2_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   betaTree_Plane2(TTree *tree=0);
   virtual ~betaTree_Plane2();
...
#ifdef betaTree_Plane2_cxx
betaTree_Plane2::betaTree_Plane2(TTree *tree) : fChain(0) 
{
...
betaTree_Plane2::~betaTree_Plane2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t betaTree_Plane2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t betaTree_Plane2::LoadTree(Long64_t entry)
{
...
void betaTree_Plane2::Init(TTree *tree)
{
...
void betaTree_Plane2::Show(Long64_t entry)
{
...
Int_t betaTree_Plane2::Cut(Long64_t entry)
{
...
#endif // #ifdef betaTree_Plane2_cxx
