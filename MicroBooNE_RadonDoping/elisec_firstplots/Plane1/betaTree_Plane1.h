...
// Mon Jun 21 16:17:47 2021 by ROOT version 6.12/06
// from TTree betaTree/ForEachTruthBeta
// found on file: outfile_mc_TESTCOMPARE.root
//////////////////////////////////////////////////////////

#ifndef betaTree_Plane1_h
#define betaTree_Plane1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        betaRecoEnergy_plane1;
   ...
   TBranch        *b_betaRecoEnergy_plane1;   //!
   ...
   betaTree_Plane1(TTree *tree=0);
   virtual ~betaTree_Plane1();
...
#ifdef betaTree_Plane1_cxx
betaTree_Plane1::betaTree_Plane1(TTree *tree) : fChain(0) 
{
...
betaTree_Plane1::~betaTree_Plane1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t betaTree_Plane1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t betaTree_Plane1::LoadTree(Long64_t entry)
{
...
void betaTree_Plane1::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("betaRecoEnergy_plane1", &betaRecoEnergy_plane1, &b_betaRecoEnergy_plane1);
...
void betaTree_Plane1::Show(Long64_t entry)
{
...
Int_t betaTree_Plane1::Cut(Long64_t entry)
{
...
#endif // #ifdef betaTree_Plane1_cxx
